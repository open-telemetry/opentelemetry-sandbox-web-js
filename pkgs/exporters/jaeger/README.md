...
```bash
npm install --save @opentelemetry/sandbox-exporter-jaeger
```
...
```js
import { JaegerExporter } from '@opentelemetry/sandbox-exporter-jaeger';
...
[npm-url]: https://www.npmjs.com/package/@opentelemetry/sandbox-exporter-jaeger
