...
```bash
npm install --save @opentelemetry/sandbox-exporter-trace-otlp-grpc
```
...
const { OTLPTraceExporter } =  require('@opentelemetry/sandbox-exporter-trace-otlp-grpc');
...
[npm-url]: https://www.npmjs.com/package/@opentelemetry/sandbox-exporter-trace-otlp-grpc
