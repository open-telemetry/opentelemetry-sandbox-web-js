...
```bash
npm install --save @opentelemetry/sandbox-instrumentation
```
...
const { UserInteractionPlugin } = require('@opentelemetry/sandbox-plugin-user-interaction');
...
[npm-url]: https://www.npmjs.com/package/@opentelemetry/sandbox-instrumentation
