...
class TestInstrumentationSimple extends InstrumentationBase {
  ...
  init() {
    return new InstrumentationNodeModuleDefinition(
      '@opentelemetry/sandbox-scoped-test-module',
      ['*'],
      moduleExports => {
...
describe('instrumenting a scoped package', function () {
  ...
  it('should patch internal file and main module', function () {
    ...
    const { getString } = require('@opentelemetry/sandbox-scoped-test-module');
   ...
   * '@opentelemetry\scoped-test-module' === '@opentelemetry/sandbox-scoped-test-module'
   *
  ...
  it('should patch main module', function () {
    ...
    } = require('@opentelemetry/sandbox-scoped-test-module');
