...
This module provides automatic instrumentation for *document load* for Web applications, which may be loaded using the [`@opentelemetry/sandbox-sdk-trace-web`](https://www.npmjs.com/package/@opentelemetry/sandbox-sdk-trace-web) package.

If total installation size is not constrained, it is recommended to use the [`@opentelemetry/sandbox-auto-instrumentations-web`](https://www.npmjs.com/package/@opentelemetry/sandbox-auto-instrumentations-web) bundle with [`@opentelemetry/sandbox-sdk-trace-web`](https://www.npmjs.com/package/@opentelemetry/sandbox-sdk-trace-web) for the most seamless instrumentation experience.
...
```bash
npm install --save @opentelemetry/sandbox-instrumentation-document-load
```
...
[npm-url]: https://www.npmjs.com/package/@opentelemetry/sandbox-instrumentation-document-load
