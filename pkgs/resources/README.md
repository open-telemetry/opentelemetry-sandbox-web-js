...
[This document][resource-semantic_conventions] defines standard attributes for resources which are accessible via [`@opentelemetry/sandbox-semantic-conventions`](https://github.com/open-telemetry/opentelemetry-js/tree/main/packages/opentelemetry-semantic-conventions).

## Installation

```bash
npm install --save @opentelemetry/sandbox-resources
```
...
[npm-url]: https://www.npmjs.com/package/@opentelemetry/sandbox-resources
