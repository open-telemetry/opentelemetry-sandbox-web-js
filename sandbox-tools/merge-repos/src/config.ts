...
export const foldersToMerge: IMergePackageDetail[] = [
    ...
    // { name: "@opentelemetry/context-zone-peer-dep", destPath: "pkgs/context/zone-peer-dep/", srcPath: "auto-merge/js/packages/opentelemetry-context-zone-peer-dep/", bundleName: "otel-sndbx.context-zone-peer-dep", bundleNamespace: "opentelemetry.sandbox.web.context-zone-peer-dep", noWorkerTests: true },
    ...
    // { name: "@opentelemetry/sdk-trace-web", destPath: "pkgs/sdk/trace-web/", srcPath: "auto-merge/js/packages/opentelemetry-sdk-trace-web/", bundleName: "otel-sndbx.sdk-trace-web", bundleNamespace: "opentelemetry.sandbox.web.sdk-trace-web" },
...
export const filesToMerge: IMergeDetail[] = [
    ...
    { srcPath: "auto-merge/js/tsconfig.base.esm.json",      destPath: "tsconfig.base.esm.json" },
