...
import { ProxyEventLoggerProvider } from '../ProxyEventLoggerProvider';

export class EventsAPI {
  private static _instance?: EventsAPI;

  private _proxyEventLoggerProvider = new ProxyEventLoggerProvider();
  ...
  public setGlobalEventLoggerProvider(
    ...
    this._proxyEventLoggerProvider.setDelegate(provider);
  ...
  public getEventLoggerProvider(): EventLoggerProvider {
    return (
      ...
      this._proxyEventLoggerProvider
    );
  }
